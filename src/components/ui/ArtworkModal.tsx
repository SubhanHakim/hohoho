    ...
    return (
        ...
        >
            <motion.div
                ...
                className="relative max-w-6xl w-full h-[90vh] flex flex-col md:flex-row overflow-hidden rounded-sm border border-gray-800 bg-gray-950"
                onClick={(e) => e.stopPropagation()}
            >
                <button
                    onClick={onClose}
                    className="absolute top-6 right-6 z-20 p-2 bg-black/50 backdrop-blur-md rounded-full text-white/50 hover:text-white hover:bg-white/10 transition-all border border-transparent hover:border-white/10"
                >
                    <X size={20} />
                </button>
                ...
                {/* Right: Info */}
                <div className="w-full md:w-[400px] border-l border-gray-800 p-8 md:p-12 flex flex-col justify-between bg-black/50">
